...
export const ADMIN_MODULES = [
  ...
  { id: 'student_list', label: 'Student List', icon: 'fa-list' },
  { id: 'interview_subjects', label: 'Interview Subjects', icon: 'fa-book' },
  { id: 'continuing_subjects', label: 'Continuing Subjects', icon: 'fa-book-open' },
