  ...
  return (
    <AdminLayout>
      <div className="ai-matters-page">
        <div className="ai-matters-shell">
          <header className="ai-matters-top">
            <div>
              <h1 className="ai-matters-top-title">
                <i className="fas fa-robot ai-matters-top-icon" aria-hidden></i>
                AI Matters
              </h1>
              <p className="ai-matters-top-sub">
                Upload PDF, CSV, or Word documents. Ask questions and get answers from their
                content.
              </p>
            </div>
          </header>
          ...
          <div className="ai-matters-grid">
            <section className="excel-card ai-matters-docs" style={{ '--accent': '#3b82f6' }}>
              <div className="excel-card-header">
                <i className="fas fa-folder-open"></i> Documents
                <span className="excel-card-count">{documents.length}</span>
              </div>
            ...
            <section className="excel-card ai-matters-chat" style={{ '--accent': '#10b981' }}>
              <div className="excel-card-header">
                <i className="fas fa-comments"></i> Ask about the documents
              </div>
              <div className="ai-matters-chat-body">
